...
enum GSM3_commandType_e { XON, NONE, MODEMCONFIG, ALIVETEST, BEGINSMS, ENDSMS, AVAILABLESMS, FLUSHSMS, FLUSHALLSMS,
	VOICECALL, ANSWERCALL, HANGCALL, RETRIEVECALLINGNUMBER, 
	ATTACHGPRS, DETACHGPRS, CONNECTTCPCLIENT, CONNECTFTPCLIENT, DISCONNECTTCP, DISCONNECTFTP, DOWNLOADFTPFILE, UPLOADFTPFILE, OPENUFSFILE, CLOSEFILE, BEGINWRITESOCKET, ENDWRITESOCKET, 
