...
enum GSM3_commandType_e { XON, NONE, MODEMCONFIG, ALIVETEST, BEGINSMS, ENDSMS, AVAILABLESMS, FLUSHSMS, FLUSHALLSMS,
	...
	ATTACHGPRS, DETACHGPRS, CONNECTTCPCLIENT, CONNECTFTPCLIENT, DISCONNECTTCP, DISCONNECTFTP, DOWNLOADFTPFILE, OPENUFSFILE, CLOSEFILE, BEGINWRITESOCKET, ENDWRITESOCKET, 
