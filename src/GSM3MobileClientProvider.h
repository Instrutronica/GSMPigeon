...
class GSM3MobileClientProvider
{
	...
	public:
		...
		*/
		...
		virtual int ftpOpenSession(char* server, int port, char* username, char* password)=0;
		
		virtual int ftpCloseSession()=0;
		...
		virtual int ufsAvailable()=0;
		
		virtual char ufsReadFileByte()=0;
		
		virtual int ufsCloseFile()=0;
		
		virtual long ftpFilesize()=0;		
